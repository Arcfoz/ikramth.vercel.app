...
const RevealCSS = () => (
  <>
    ...
    <style>{`
      ...
      /* Hover effects for cards - no transform to avoid Reveal conflicts */
      .req-card {
      ...
      @keyframes pulse-glow {
        ...
        50% { box-shadow: 0 0 16px 2px rgba(16, 185, 129, 0.12); }
      }

      /* Slide entry - opacity only, no transform (Reveal.js owns transforms) */
      ...
      .reveal::after {
        ...
        bottom: 0;
        background:
          radial-gradient(1px 1px at 20% 30%, rgba(16, 185, 129, 0.2), transparent),
          radial-gradient(1px 1px at 75% 15%, rgba(52, 211, 153, 0.15), transparent),
          radial-gradient(1px 1px at 50% 80%, rgba(16, 185, 129, 0.1), transparent),
          radial-gradient(1px 1px at 85% 65%, rgba(5, 150, 105, 0.15), transparent);
        pointer-events: none;
        z-index: -1;
      }
    `}</style>
