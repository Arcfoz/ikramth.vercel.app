import { getCertificate } from "@/sanity/sanity.query";
...
export default async function CerfSection() {
  const cerfs: CertificateType[] = await getCertificate();
  ...
  return (
    <main>
      ...
      <div className="flex flex-col gap-y-12">
        {cerfs.map((cerf) => {
          const startDate = moment(cerf.startDate);
          const endDate = moment(cerf.endDate);
